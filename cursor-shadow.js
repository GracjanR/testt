...
document.addEventListener('DOMContentLoaded', function() {
    ...
    shadow.style.borderRadius = '50%';
    shadow.style.boxShadow = '0 0 40px 20px rgba(30,144,255,0.38), 0 0 80px 10px rgba(0,0,0,0.22)';
    shadow.style.transition = 'transform 0.08s cubic-bezier(.4,1.6,.6,1), opacity 0.3s ease-out'; // Dodana płynna zmiana opacity
    shadow.style.transform = 'translate(-100px, -100px)';
    shadow.style.opacity = '0'; // Początkowo ukryty
